...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        '''was published_recently() returns False for questions was pub_date is older than 1 day'''
    ...
    def test_was_published_recently_with_recent_question(self):
        '''was published_recently() returns True for questions was pub_date is withing the last day'''
